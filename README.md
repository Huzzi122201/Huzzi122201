...
- 🤖 Exploring AI/DL — from self-supervised vision models to multimodal captioning
- 💻 Building modern web apps & tools with JavaScript/TypeScript
- 🚀 Passionate about full-stack development, AI products & automation
- 🏢 Co-founder of **SoccerVision** — AI-powered football analysis platform
...
| --- | --- | --- | --- |
| [Masked-Autoencoder-MAE](https://github.com/Huzzi122201/Masked-Autoencoder-MAE) | Self-supervised image representation learning on Tiny ImageNet — reconstructs images from 25% visible patches using an asymmetric ViT encoder-decoder (~108M params) | Python · PyTorch · Streamlit | 2026 |
| [Neural-Storyteller](https://github.com/Huzzi122201/Neural-Storyteller) | Image captioning with a Seq2Seq ResNet50 + LSTM architecture, achieving BLEU-4 of 0.31 on Flickr30k; interactive Streamlit demo with beam search | Python · PyTorch · Streamlit | 2026 |
| [AI-Pitch-Writer](https://github.com/Huzzi122201/AI-Pitch-Writer) | Full-stack AI web app that generates compelling business pitches — magic-link auth, n8n workflow automation, MongoDB storage | Next.js · TypeScript · Supabase · n8n | 2026 |
| 🔒 SoccerVision *(private)* | Co-founder · AI platform that turns 90-min football matches into automated highlights, event detection (goals/fouls/saves), player reels & H2H stats | Python · PyTorch · Computer Vision | Active |
